          ...
          Padding(
            ...
            child: Column(
              children: entity.attributes.map((attr) {
                final bool isMatch = searchQuery != null &&
                    searchQuery!.isNotEmpty &&
                    attr.name.toLowerCase().contains(searchQuery!.toLowerCase());

                return Container(
                  margin: const EdgeInsets.symmetric(vertical: 3),
                  padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 6),
                  decoration: BoxDecoration(
                    color: isMatch ? const Color(0xFFFEF3C7) : Colors.transparent,
                    borderRadius: BorderRadius.circular(6),
                  ),
                  child: Row(
                    children: [
                      ...
                      if (attr.isPrimaryKey)
                        Container(
                          ...
                          child: const Row(
                            ...
                            children: [
                              Icon(Icons.vpn_key_rounded, size: 10, color: Color(0xFFD97706)),
                              SizedBox(width: 3),
                              Text(
                                'PK',
                                style: TextStyle(
                        ...
                        Container(
                          ...
                          child: const Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Icon(Icons.link_rounded, size: 10, color: Color(0xFF2563EB)),
                              SizedBox(width: 3),
                              Text(
                                'FK',
                                style: TextStyle(
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(
                            fontSize: 12.5,
                            fontWeight: attr.isPrimaryKey ? FontWeight.w700 : FontWeight.w500,
                            color: const Color(0xFF0F172A),
                          ),
                        ),
                      ),
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: entity.relationships.map((rel) {
                      ...
                      final targetName = isOrigin ? rel.toEntity : rel.fromEntity;
                      ...
                      return Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                              isOrigin ? Icons.arrow_forward_rounded : Icons.arrow_back_rounded,
                              size: 11,
